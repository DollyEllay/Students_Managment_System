...
public class students {
    ...
    public static void main(String[] args) {
        ...
        String filePath = "C:\\Users\\csp\\Documents\\Projects\\LMS\\student-data (1).txt";
        try {
        ...
        String input = "\n" +
                "1#Malcolm Barnes#9#velit.aliquam@outlook.couk#375-3721 Elementum_ Road#Adana#United Kingdom$" +
        ...
        // Add headers row to the list of records
        List<String> csvRecords = new ArrayList<>();
        csvRecords.add("id,name,Grade,email,address,region,country");

        // Add id to each record and convert # to , and $ to \n
        for (int i = 0; i < records.length; i++) {
            String record = records[i];
            String[] fields = record.split("#");
            String id = Integer.toString(i + 1);
            String newRecord = id + "," + String.join(",", fields);
